...
class _SignUpScreenState extends ConsumerState<SignUpScreen> {
  ...
  void newUseCreation(ref, context) {
    ref.read(authControllerProvider).newUserCreation(_emailController.text, _password.text, context);
  }
              ...
              if (emailClick)
                Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                      text: "Continue",
                      onTap: () => newUseCreation(ref, context),
                    ),
                  ],
                ),
              const SizedBox(height: 20),
